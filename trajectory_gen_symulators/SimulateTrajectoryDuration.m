...
toPlotForLatex(['[DUR]positions:q0:' num2str(q_0) 'q1:' num2str(q_1) ...
                'v0:' num2str(v_0) 'v1:' num2str(v_1) 'vmax:' num2str(v_v)...
                'amax:' num2str(a_max)], time, positions);
% toPlotForLatex(['[DUR]velocities:q0:' num2str(q_0) 'q1:' num2str(q_1) ...
%                 'v0:' num2str(v_0) 'v1:' num2str(v_1) 'vmax:' num2str(v_v)...
%                 'amax:' num2str(a_max)], time, velocities);
% toPlotForLatex(['[DUR]accelerations:q0:' num2str(q_0) 'q1:' num2str(q_1) ...
%                 'v0:' num2str(v_0) 'v_1:' num2str(v1) 'vmax:' num2str(v_v)...
%                 'amax:' num2str(a_max)], time, accelerations);
end