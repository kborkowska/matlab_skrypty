...
toPlotForLatex(['[VEL]positions:q0:' num2str(q_0) 'q1:' num2str(q_1) ...
...
% toPlotForLatex(['[VEL]velocities:q0:' num2str(q_0) 'q1:' num2str(q_1) ...
%                 'v0:' num2str(v_0) 'v1:' num2str(v_1) 'vmax:' num2str(v_v)...
%                 'amax:' num2str(a_max)], time, velocities);
% toPlotForLatex(['[VEL]accelerations:q0:' num2str(q_0) 'q1:' num2str(q_1) ...
%                 'v0:' num2str(v_0) 'v1:' num2str(v_1) 'vmax:' num2str(v_v)...
